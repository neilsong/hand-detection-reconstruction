...
if __name__ == "__main__":
    ...
    hands_pklfile = open('pkl_cache/hands_pkl', 'ab')
    pickle.dump(hands_pkl, hands_pklfile)
    hands_pklfile.close()

    det_frames_pklfile = open('pkl_cache/det_frames_pkl', 'ab')
    pickle.dump(det_frames, det_frames_pklfile)
    det_frames_pklfile.close()
